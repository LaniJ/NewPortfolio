...
const contact = () => {
  return ( 
    <div className="flex flex-col text-center mt-40 mb-[89px]">
      ...
      <div className="flex bg-[#112240] box-border py-[28px] hover:bg-cyan-600 rounded-[20px]">
       <a href="https://twitter.com/juyi_y" target="_blank" className='px-[25px]'>
        <Image
          src={twitterIcon}
          alt="twitter icon" 
        />
       </a>
       <a href="https://github.com/LaniJ" target="_blank" className='px-[25px]'>
        <Image
          src={githubIcon}
          alt="github icon" 
        />
       </a>
       <a href="https://www.linkedin.com/in/oluwalani/" target="_blank" className='px-[25px]'>
        <Image
          src={linkedinIcon}
          alt="linkedin icon" 
        />
